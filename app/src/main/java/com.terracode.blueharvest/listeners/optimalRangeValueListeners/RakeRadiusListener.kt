...
class RakeRadiusListener(
    private val activity: ConfigurationSettingsActivity,
    private val rakeRadiusInput: EditText
) :
    TextWatcher {
    //Colors
    ...
    //Constants
    private val configName = ContextCompat.getString(activity, R.string.rakeRadiusTitle)
            ...
            if (input.isNotEmpty()) {
                ...
                value?.let {
                    if (it > maxInput){
                        ...
                        rakeRadiusInput.setTextColor(redColor)
                        rakeRadiusInput.setBackgroundResource(R.drawable.edit_text_red_border)
                        ...
                        rakeRadiusInput.setTextColor(blackColor)
                        rakeRadiusInput.setBackgroundResource(R.drawable.edit_text_normal)
                        PreferenceManager.setRakeRadiusInput(it)
                    }
                }
            }
        }
